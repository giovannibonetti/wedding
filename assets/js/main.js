$(document).ready(function() {
    ...
    var target_date = new Date("2016-12-17T12:30:00").getTime();
    ...
    map.addMarker({
        ...
        infoWindow: {
            content: '<div class="note">Cerimônia</div><h4 class="map-title script">Igreja Bom Jesus do Cabral</h4><div class="address"><span class="region">Rua Bom Jesus, 159</span><br><span class="postal-code">80035-010</span><br><span class="city-name">Curitiba</span></div>'
        }
    ...
    map.addMarker({
        ...
        infoWindow: {
            content: '<div class="note">recepção</div><h4 class="map-title script">Restaurante Dom Antonio</h4><div class="address"><span class="region">Avenida Manoel Ribas, 6121</span><br><span class="postal-code">82400-000</span><br><span class="city-name">Curitiba</span></div>'
        }
